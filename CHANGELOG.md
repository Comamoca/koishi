...
- ci: add Hex publish workflow by @Comamoca in https://github.com/Comamoca/koishi/pull/2
- ci: use latest Erlang/OTP and Gleam by @Comamoca in https://github.com/Comamoca/koishi/pull/3
- fix: add Deno permissions for tests by @Comamoca in https://github.com/Comamoca/koishi/pull/4
